...
class DefaultToggle extends StatefulWidget {
  ...
  const DefaultToggle({
    ...
    this.activeColor = ThemeColors.orange500,
    this.inactiveColor = ThemeColors.coolgray200,
  ...
  @override
  _DefaultToggleState createState() => _DefaultToggleState();
}
...
class _DefaultToggleState extends State<DefaultToggle>
  ...
  @override
  void didUpdateWidget(DefaultToggle oldWidget) {
                    ...
                    children: <Widget>[
                      ...
                      Align(
                        ...
                        child: PhysicalModel(
                          ...
                          child: Container(
                            width: widget.toggleSize.h,
                            height: widget.toggleSize.h,
