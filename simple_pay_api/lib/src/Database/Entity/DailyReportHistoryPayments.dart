...
@Entity(tableName: "BI1_DAILY_RPT_HIS_PAYMENTS", indices: const [
  Index(value: ["STR_TRM_ID", "COM_DT", "COM_SNO", "PAY_SEC_CD"], unique: true)
])
class DailyReportHistoryPayments {
  @primaryKey
  @ColumnInfo(name: "ID")
  String? id;
